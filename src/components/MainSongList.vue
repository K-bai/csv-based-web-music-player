<template>
  <div class="c-main">
    ...
    <div class="c-controler">
      <button class="general-button general-button-grey controler-item controler-item-all" v-on:click="all_song_to_playlist">全部筛选结果加入播放列表</button>
    </div>
    <div class="c-song-list">
      ...
      >
        ...
        <div class="song-list-item-details" v-show="is_expanded[idx]">
          <div class="song-full-details-language" v-show="song.language!==''">语言: {{song.language}}</div>
